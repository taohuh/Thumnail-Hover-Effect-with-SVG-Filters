...
exports.getMousePosition = exports.lerp = void 0;
...
window.addEventListener('mousemove', function (event) {
  return mouse = (0, _utils.getMousePosition)(event);
});
...
var Cursor = /*#__PURE__*/function () {
  function Cursor(el) {
    ...
    this.onMouseMoveEvent = function () {
      // Make cursor image to current mouse
  ...
  _createClass(Cursor, [{
    ...
    value: function render() {
      ...
      this.DOM.el.style.transform = "\n      translateX(".concat(this.renderedStyles['tx'].previous, "px)\n      translateY(").concat(this.renderedStyles['ty'].previous, "px)\n      scale(").concat(this.renderedStyles['scale'].previous, ")\n    ");
...
},{"gsap":"../node_modules/gsap/index.js","./utils":"js/utils.js"}],"js/item.js":[function(require,module,exports) {
"use strict";
...
var Item = /*#__PURE__*/function () {
  ...
  _createClass(Item, [{
    ...
    key: "updateTurbulenceBaseFrequency",
    value: function updateTurbulenceBaseFrequency() {
      var val = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.primitiveValues.baseFrequency;
      this.DOM.feTurbulence.setAttribute('baseFrequency', val);
    }
  }, {
    key: "updateDisplacementMapScale",
    value: function updateDisplacementMapScale() {
      var val = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.primitiveValues.scale;
    ...
    value: function createHoverTimeline() {
      ...
      this.tl = _gsap.gsap.timeline({
        ...
        onUpdate: function onUpdate() {
          return _this2.updateFilterValues();
        },
        onReverseComplete: function onReverseComplete() {
          if (_this2.filterType === 'turbulence') {
            _this2.primitiveValues.baseFrequency = 0;

            _this2.updateFilterValues();
          }
        }
      });
...
_toConsumableArray(document.querySelectorAll('.item')).forEach(function (item) {
  return new _item.Item(item);
});
},{"./cursor":"js/cursor.js","./item":"js/item.js"}],"../../../.nvm/versions/node/v12.14.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
